...
```{r add_logo, echo = F, eval = T, message = F, fig.width=15, fig.asp = .20}
library(here)
knitr::include_graphics(here::here("./blog/img/SFSE_blog_logo.png"), dpi = NA)
```
...
Please feel free to contact me on [email](mailto:statsforscaredecologists@gmail.com){target="_blank"} or [Twitter](https://twitter.com/stats_ecology){target="_blank"} if you have any questions or suggestions for blogposts. 
